<?php
/**
 * Block registration, shared attributes, and front-end style enqueue.
 *
...
use CrocoBlocks\BlockSupport\AdvancedSpacingAttributes;
...
class BlockController {
	...
	public static function merge_advanced_spacing_attributes( $args, $name ) {
		...
		$shared = AdvancedSpacingAttributes::get_block_attributes();
